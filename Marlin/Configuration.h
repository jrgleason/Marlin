...
#define STRING_CONFIG_H_AUTHOR "(Gleason, Jackie)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Jackie's Printer E3Pro 4.2.7"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {   9.38,   9.38 }
    #define DEFAULT_Ki_LIST {   0.47,   0.47 }
    #define DEFAULT_Kd_LIST {  46.44,  46.44 }
  #else
    #define DEFAULT_Kp   9.38
    #define DEFAULT_Ki   0.47
    #define DEFAULT_Kd  46.44
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 116.08
  #define DEFAULT_bedKi 20.88
  #define DEFAULT_bedKd 430.26
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -36, 5, -3 }
...
#define Y_MAX_POS Y_BED_SIZE - 31
